    ...
    <div className="App flex flex-col items-center min-h-screen justify-start bg-gray-200 m-0 realtive">
      ...
      {showPopup && (
        ...
        <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white p-6 rounded-md shadow-lg z-100 border border-gray-300 text-center">
          <p className="mb-4">👋 Hey there! Welcome to Katy Grade Calc, a completely free website that calculates your Katy ISD grades. Please make sure you visit the how to use page before using our calculators. Disclaimer: this website was not created nor endorsed by Katy ISD.</p>
         <p className = "mb-4 font-bold">Calculators are up to date for the 2025-26 KISD school year.</p>
