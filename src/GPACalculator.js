...
function GPACalculator() {
  ...
  return (
    <div className="p-8 bg-white">
      ...
      />
      <button onClick={calculateGPA} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg shadow-md transition duration-300 ease-in-out">
        Calculate GPA
      </button>
