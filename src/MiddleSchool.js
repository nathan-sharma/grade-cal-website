...
function MiddleSchool() {
  ...
  const calculateAverage = () => {
    ...
    if (majorsCount >= 1 && minorsCount === 0 && othersCount === 0) {
      ...
      finalAvgKap = 0.55 * avgMajors + 0.3 * avgMinors + 0.15 * avgOthers;
      finalAvgAca = 0.5 * avgMajors + 0.35 * avgMinors + 0.15 * avgOthers;
    }

    setResults({ kap: finalAvgKap, aca: finalAvgAca});
  ...
  return (
    // Step 1: Add "flex-col" to make the items stack vertically
    ...
    <div className="App flex flex-col items-center min-h-screen justify-start bg-gray-200 m-0">
        ...
        <div className="mt-6 p-6 w-auto max-w-2xl h-full">
          ...
          <div className="bg-white p-8 mt-5">
            ...
            <div className="flex items-center mb-4">
              <button
                className="bg-orange-600 hover:bg-orange-900 text-white font-bold py-2 px-4 rounded"
                onClick={calculateAverage}
              >
                Calculate
              </button>
              <button
                className="bg-orange-600 hover:bg-orange-900 text-white font-bold py-2 px-4 rounded ml-3"
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
                <div className="bg-white p-8 rounded-lg w-1/2  w-[90vw] md:w-[40vw] max-h-[70vh] overflow-y-auto overflow-x-auto">
                  ...
                  <div className="flex items-center justify-center">
                    <button
                      className="bg-orange-600 hover:bg-orange-900 text-white font-bold py-2 px-4 rounded mt-1 mb-3"
                        ...
                        <li key={index} className="mb-4 border-b pb-2">
                          ...
                          <div className="flex">
                            ...
                            <button
                              ...
                              className="text-orange-600 hover:text-orange-800 mt-2 ml-3 underline"
                            >
                              Enter in calculator
                            </button>
                          </div>
      ...
      {/* Footer is now correctly positioned at the end of the flex container */}
      <Footer/>
